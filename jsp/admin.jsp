<%-- 
    Document   : admin
    Created on : Jun 22, 2016, 11:39:26 AM
    Author     : java4
--%>
...
<div id="outter">
  <div id="inner">
    ...
    <div id="content_wrapper">
      <div class="alignCenter">
        <div class="content">
          <br><h3><font style="color: #000000 ">Admin Login</font></h3>
          
<!--          <div class="thumbs yoxview">-->
<img style="height: 280px; width: 620px" src="images/admin.jpg" />
<div>
<form action="Login.jsp" method="get"> 
    <br><input type="text" name="uname" placeholder="Admin Name" required=""><br><br>
