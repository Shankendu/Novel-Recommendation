<%-- 
    ...
    Created on : Jun 29, 2016, 4:14:50 PM
    Author     : java4
--%>
...
<div style="overflow-y:scroll; height:500px"><table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 400px;  font-size: 16px">Book ID</th>
                                <th style="text-align: center;width: 400px;  font-size: 16px">Ratings</th>
                                <!--<th style="text-align: center;width: 200px;  font-size: 16px">DOB</th>-->
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from book_rating");
                                        while(rs.next())
