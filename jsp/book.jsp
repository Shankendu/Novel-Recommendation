<%-- 
    Document   : book
    Created on : Jun 29, 2016, 5:07:40 PM
    Author     : java4
--%>
...
<div id="outter">
      ...
      <div class="alignCenter">
        <div class="content">
            ...
            <div class="col_w300 last_col">
              ...
              <br><legend><font color="#FF8000" size="4"><strong>Search Book Details</strong></font></legend>
 ...
 <form name="frm" method="get" action="book_show.jsp">	
