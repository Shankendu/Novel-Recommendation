<%-- 
    Document   : user_de
    Created on : Jun 22, 2016, 2:56:14 PM
    Author     : java4
--%>
...
<div style="overflow-y:scroll; height:500px"><table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 400px;  font-size: 16px">Location</th>
                                <th style="text-align: center;width: 400px;  font-size: 16px">Age</th>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from bx_users");
                                        while(rs.next())
