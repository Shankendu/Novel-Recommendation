<%-- 
    ...
    Created on : Jun 28, 2016, 6:25:32 PM
    Author     : java4
--%>
...
<div style="overflow-y:scroll; height:500px"><table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                <th style="text-align: center;width: 100px; font-size: 16px">Book ID</th>
                                <th style="text-align: center;width: 400px;  font-size: 16px">Book Title</th>
                                <th style="text-align: center;width: 200px;  font-size: 16px">Author</th>
                                <th style="text-align: center;width: 100px;  font-size: 16px">Year of Publish</th>
                                <th style="text-align: center;width: 100px;  font-size: 16px">Publisher</th>
                                <!--
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from bx_books");
                                        while(rs.next())
                                            
                                        {
            %>
            <th><%=rs.getString("ISBN")%></th>
            <th><%=rs.getString("book_title")%></th>
            <th><%=rs.getString("book_author")%></th>
            <th><%=rs.getString("yop")%></th>
